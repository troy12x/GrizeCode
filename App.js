...
function TabNavigator() {
  return (
      ...
      <Tab.Navigator screenOptions={{headerShown: false}} tabBar={props => <MyTabBar {...props} />}>
        <Tab.Screen name="HomeScreen" component={HomeScreen} options={{tabBarIcon: "home"}} />
        <Tab.Screen name="CartScreen" component={CartScreen} options={{tabBarIcon: "cart"}} />
        {/* <Tab.Screen name="AddMoney" component={AddMoney} options={{tabBarIcon: "plus"}} /> */}
        <Tab.Screen name="SettingScreen" component={SettingScreen} options={{tabBarIcon: "setting"}} />
        <Tab.Screen name="ProfileScreen" component={ProfileScreen} options={{tabBarIcon: "user"}} />
